...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对it职业生涯规划系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对it职业生涯规划系统进行介绍时，将按照如下内容进行。

第一部分：介绍it职业生涯规划系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发it职业生涯规划系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对it职业生涯规划系统的功能要求，以及对it职业生涯规划系统的性能要求等；
...
# 第2章 开发环境与技术
it职业生涯规划系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对it职业生涯规划系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，it职业生涯规划系统开发可行。
### 3.1.3 操作可行性
it职业生涯规划系统根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作it职业生涯规划系统。
...
![C:/Users/Administrator/Desktop/temp111\1\img\论坛.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\论坛.jpg")
论坛实体属性图

（7）下图是试卷表实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\试卷表.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\试卷表.jpg")
试卷表实体属性图

（8）下图是职业介绍实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\职业介绍.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\职业介绍.jpg")
职业介绍实体属性图

（9）下图是职业介绍收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\职业介绍收藏.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\职业介绍收藏.jpg")
职业介绍收藏实体属性图
...
![C:/Users/Administrator/Desktop/temp111\1\img\课程学习.jpg](/md/blog.016.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\课程学习.jpg")
课程学习实体属性图

（12）下图是课程收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\课程收藏.jpg](/md/blog.017.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\课程收藏.jpg")
课程收藏实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xuexishipin\_name|String|课程名称|是|
|3|xuexishipin\_photo|String|课程封面|是|
|4|xuexishipin\_types|Integer|课程类型|是|
|5|zhiyejieshao\_types|Integer|职业|是|
|6|xuexishipin\_content|String|课程详情|是|
|7|xuexishipin\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xuexishipin\_id|Integer|课程|是|
|3|yonghu\_id|Integer|用户|是|
|4|xuexishipin\_collection\_types|Integer|类型|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhiyejieshao\_name|String|职业名称|是|
|3|zhiyejieshao\_photo|String|职业封面|是|
|4|zhiyejieshao\_types|Integer|职业|是|
|5|zhiyejieshao\_content|String|职业详情|是|
|6|zhiyejieshao\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhiyejieshao\_id|Integer|职业介绍|是|
|3|yonghu\_id|Integer|用户|是|
|4|zhiyejieshao\_collection\_types|Integer|类型|是|
|5|insert\_time|Date|收藏时间|是|
|6|create\_time|Date|创建时间|是|
表4.14管理员表
